...
server.httpServer = http.createServer((req, res) => {
    ...
    */
    ...
    const isAPI = false;
    const isHTML = !isTextFile && !isBinaryFile && !isAPI;

    // console.log(pathParts);
    console.log(trimmedPath, '-->', fileExtension);
    ...
    req.on('end', () => {
        ...
        if (isTextFile) {
            responseContent = 'Stai tau tekstinis failas...';
        }

        if (isBinaryFile) {
            responseContent = 'Stai tau binary failas...';
        }
